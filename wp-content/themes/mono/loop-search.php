...
<?php else: ?>
	...
	<?php while ( have_posts() ) : the_post(); ?>
		<li>
			<p class="result-title"><a class="result-title" href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'cudazi' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></p>
