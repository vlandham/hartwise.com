<?php 
	...
	$portfolio_archive_layout = cudazi_get_option( get_option_tree('portfolio_archive_layout', $cudazi_theme_options, false, false ), '', false ); 
	$portfolio_archive_posts_per_page = cudazi_get_option( get_option_tree('portfolio_archive_posts_per_page', $cudazi_theme_options, false, false ), '', false ); 
?>
