<?php
/*
* Plugin Name: Cudazi Latest Posts Widget
...
class Cudazi_LatestPostsWidget extends WP_Widget {

    function Cudazi_LatestPostsWidget() {
		$widget_options = array('classname' => 'cudazi-latest-posts', 'description' => __( 'Reusable custom posts by Cudazi.', 'cudazi') );
		$control_options = array( 'width' => 300, 'height' => 350 );
        parent::WP_Widget(false, $name = __( 'Cudazi Latest Posts', 'cudazi'), $widget_options, $control_options );	
    }
    ...
    function form($instance) {		
        ...
        ?>
            ...
            <p><label for="<?php echo $this->get_field_id('cat'); ?>"><?php _e('Category IDs:','cudazi'); ?> <input class="widefat" id="<?php echo $this->get_field_id('cat'); ?>" name="<?php echo $this->get_field_name('cat'); ?>" type="text" value="<?php echo $cat; ?>" /></label></p>			
        <?php 
    }

}

// register Cudazi_LatestPostsWidget widget
add_action('widgets_init', create_function('', 'return register_widget("Cudazi_LatestPostsWidget");'));
