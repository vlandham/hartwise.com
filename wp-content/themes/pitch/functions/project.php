...
function pitch_project_init(){
	...
	$args = array(
		...
		'show_in_menu' => true,
		'query_var' => true,
		'rewrite' => array( 'slug' => siteorigin_setting('project_url_slug') ),
		'capability_type' => 'post',
		'has_archive' => true,
		'hierarchical' => false,
		'menu_position' => null,
		'supports' => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'comments' ),
		'menu_icon' => get_template_directory_uri() . '/images/post-types/project-small.png'
	);
...
function pitch_add_project_metabox(){
	add_meta_box(
		...
		'pitch_project_video_metabox_render',
		'project',
		'side'
	);
}
 ...
 */
function pitch_project_video_metabox_render($post){
	siteorigin_premium_call_function(
		'pitch_premium_project_metabox_render',
		array($post),
		array(
			'description' => __('Pitch Premium lets you display videos on the left side of projects', 'pitch')
		)
	);
}
