<div id="slider">
	<div class="container">
		<div class="slides nivoSlider">
			<img src="<?php echo esc_url(get_template_directory_uri().'/demo/slide.jpg') ?>" />
			<img src="<?php echo esc_url(get_template_directory_uri().'/demo/slide-2.jpg') ?>" />
			<img src="<?php echo esc_url(get_template_directory_uri().'/demo/slide-3.jpg') ?>" />
		</div>
